...
function buildDefaultLandingContentRows() {
  return [
    ...
    lc(true, 'about.mentor_2_img', 'About', 'Link ảnh mentor 2', '#mentor2-img', 'src', '', 'assets/images/mentor_cuong.png'),
    ...
    lc(true, 'methods.tag', 'Methods', 'Tag section', '#methods .section-tag', 'text', '', 'GÓI TƯ VẤN LINH HOẠT 3 TRONG 1'),
    lc(true, 'methods.title', 'Methods', 'Tiêu đề section', '#methods .section-title', 'html', '', 'Một Buổi Tư Vấn, <em>Ba Lăng Kính Soi Chiếu</em>'),
    lc(true, 'methods.desc', 'Methods', 'Mô tả section', '#methods .section-desc', 'html', '', 'Chọn góc nhìn bạn muốn đào sâu hoặc kết hợp cả ba hệ quy chiếu để nhận được<br/>bức tranh rõ hơn về câu chuyện hiện tại của mình.'),
    
    lc(true, 'methods.clow_letter', 'Methods', 'Clow - Chữ cái', '.method-clow .method-letter', 'text', '', 'C'),
    lc(true, 'methods.clow_subtitle', 'Methods', 'Clow - Subtitle', '.method-clow .method-subtitle', 'text', '', 'CLOW GUIDANCE'),
    lc(true, 'methods.clow_title', 'Methods', 'Clow - Tiêu đề', '.method-clow .method-title', 'text', '', 'Bài Clow'),
    lc(true, 'methods.clow_desc', 'Methods', 'Clow - Mô tả', '.method-clow .method-desc', 'text', '', 'Lắng nghe thông điệp từ từng lá bài để nhìn rõ điều đang mắc kẹt.'),
    lc(true, 'methods.clow_tag1', 'Methods', 'Clow - Tag 1', '.method-clow .method-tags span:nth-child(1)', 'text', '', 'Chữa lành'),
    lc(true, 'methods.clow_tag2', 'Methods', 'Clow - Tag 2', '.method-clow .method-tags span:nth-child(2)', 'text', '', 'Định hướng'),
    lc(true, 'methods.clow_back_title', 'Methods', 'Clow - Tiêu đề sau', '.method-clow .method-back-title', 'text', '', 'Thông điệp và lộ trình hành động'),
    lc(true, 'methods.clow_back_desc', 'Methods', 'Clow - Mô tả sau', '.method-clow .method-back-desc', 'text', '', 'Bài Clow giúp bạn gọi tên năng lượng hiện tại, nhận diện rào cản cảm xúc và chọn bước đi gần nhất phù hợp với hoàn cảnh thật.'),
    lc(true, 'methods.clow_back_item1', 'Methods', 'Clow - Bullet 1', '.method-clow .method-back-list li:nth-child(1) span', 'text', '', 'Phân tích chủ đề trọng tâm'),
    lc(true, 'methods.clow_back_item2', 'Methods', 'Clow - Bullet 2', '.method-clow .method-back-list li:nth-child(2) span', 'text', '', 'Gợi ý hành động dễ áp dụng'),
    lc(true, 'methods.clow_back_item3', 'Methods', 'Clow - Bullet 3', '.method-clow .method-back-list li:nth-child(3) span', 'text', '', 'Thông điệp chữa lành cá nhân'),

    lc(true, 'methods.astro_letter', 'Methods', 'Astro - Chữ cái', '.method-astro .method-letter', 'text', '', 'A'),
    lc(true, 'methods.astro_subtitle', 'Methods', 'Astro - Subtitle', '.method-astro .method-subtitle', 'text', '', 'ASTROLOGY MAP'),
    lc(true, 'methods.astro_title', 'Methods', 'Astro - Tiêu đề', '.method-astro .method-title', 'text', '', 'Chiêm tinh'),
    lc(true, 'methods.astro_desc', 'Methods', 'Astro - Mô tả', '.method-astro .method-desc', 'text', '', 'Quan sát nhịp vận hành, xu hướng tính cách và thời điểm chuyển mình.'),
    lc(true, 'methods.astro_tag1', 'Methods', 'Astro - Tag 1', '.method-astro .method-tags span:nth-child(1)', 'text', '', 'Bản đồ sao'),
    lc(true, 'methods.astro_tag2', 'Methods', 'Astro - Tag 2', '.method-astro .method-tags span:nth-child(2)', 'text', '', 'Chu kỳ'),
    lc(true, 'methods.astro_back_title', 'Methods', 'Astro - Tiêu đề sau', '.method-astro .method-back-title', 'text', '', 'Hiểu nhịp vận hành cá nhân'),
    lc(true, 'methods.astro_back_desc', 'Methods', 'Astro - Mô tả sau', '.method-astro .method-back-desc', 'text', '', 'Chiêm tinh bổ sung góc nhìn về khí chất, cách phản ứng, nhu cầu cảm xúc và những giai đoạn nên tiến, nên lùi hoặc nên chuẩn bị kỹ hơn.'),
    lc(true, 'methods.astro_back_item1', 'Methods', 'Astro - Bullet 1', '.method-astro .method-back-list li:nth-child(1) span', 'text', '', 'Nhận diện thế mạnh tự nhiên'),
    lc(true, 'methods.astro_back_item2', 'Methods', 'Astro - Bullet 2', '.method-astro .method-back-list li:nth-child(2) span', 'text', '', 'Đọc xu hướng giai đoạn hiện tại'),
    lc(true, 'methods.astro_back_item3', 'Methods', 'Astro - Bullet 3', '.method-astro .method-back-list li:nth-child(3) span', 'text', '', 'Gợi ý cách ra quyết định hài hòa'),

    lc(true, 'methods.numero_letter', 'Methods', 'Numero - Chữ cái', '.method-numero .method-letter', 'text', '', 'N'),
    lc(true, 'methods.numero_subtitle', 'Methods', 'Numero - Subtitle', '.method-numero .method-subtitle', 'text', '', 'NUMEROLOGY CODE'),
    lc(true, 'methods.numero_title', 'Methods', 'Numero - Tiêu đề', '.method-numero .method-title', 'text', '', 'Nhân số'),
    lc(true, 'methods.numero_desc', 'Methods', 'Numero - Mô tả', '.method-numero .method-desc', 'text', '', 'Giải mã con số chủ đạo, bài học linh hồn và kiểu phát triển phù hợp.'),
    lc(true, 'methods.numero_tag1', 'Methods', 'Numero - Tag 1', '.method-numero .method-tags span:nth-child(1)', 'text', '', 'Năng lực'),
    lc(true, 'methods.numero_tag2', 'Methods', 'Numero - Tag 2', '.method-numero .method-tags span:nth-child(2)', 'text', '', 'Bài học'),
    lc(true, 'methods.numero_back_title', 'Methods', 'Numero - Tiêu đề sau', '.method-numero .method-back-title', 'text', '', 'Giải mã bản thiết kế nội tại'),
    lc(true, 'methods.numero_back_desc', 'Methods', 'Numero - Mô tả sau', '.method-numero .method-back-desc', 'text', '', 'Nhân số giúp bạn hiểu nhịp phát triển, động lực sâu bên trong và những bài học lặp lại trong học tập, công việc, tình cảm hoặc tài chính.'),
    lc(true, 'methods.numero_back_item1', 'Methods', 'Numero - Bullet 1', '.method-numero .method-back-list li:nth-child(1) span', 'text', '', 'Đọc con số chủ đạo và năm cá nhân'),
    lc(true, 'methods.numero_back_item2', 'Methods', 'Numero - Bullet 2', '.method-numero .method-back-list li:nth-child(2) span', 'text', '', 'Nhận diện mẫu hành vi lặp lại'),
    lc(true, 'methods.numero_back_item3', 'Methods', 'Numero - Bullet 3', '.method-numero .method-back-list li:nth-child(3) span', 'text', '', 'Chọn hướng phát triển bền vững'),

    lc(true, 'methods.cta', 'Methods', 'Nút đặt lịch ngay', '#btn-methods-booking', 'html', '', '<i class="fa-solid fa-sparkles"></i> Đặt lịch ngay'),
